...
sns.countplot(x="salary", data=df, order=["low", "medium", "high"], palette="magma")
...
# Используем suptitle для общего заголовка FacetGrid и регулируем его положение
g.fig.suptitle(
